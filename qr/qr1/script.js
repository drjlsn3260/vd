...
function init() {
  ...
  add.addEventListener('click', () => {
    content.insertBefore(createQR('https://github.com/bdgbqq390/www/blob/master/README.md?a#1'), add)
  });
  ...
  let localQr = JSON.parse(localStorage.getItem('_local_qr_codes_') || '["https://github.com/bdgbqq390/www/blob/master/README.md?a#1"]');
