...
function init() {
  ...
  add.addEventListener('click', () => {
    content.insertBefore(createQR('https://github.com/saiqwn3714/www/blob/master/README.md?p#1'), add)
  });
  ...
  let localQr = JSON.parse(localStorage.getItem('_local_qr_codes_') || '["https://github.com/saiqwn3714/www/blob/master/README.md?p#1"]');
