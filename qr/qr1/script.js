...
function init() {
  ...
  add.addEventListener('click', () => {
    content.insertBefore(createQR('https://github.com/odwrwk3904/www/blob/master/README.md?d#1'), add)
  });
  ...
  let localQr = JSON.parse(localStorage.getItem('_local_qr_codes_') || '["https://github.com/odwrwk3904/www/blob/master/README.md?d#1"]');
