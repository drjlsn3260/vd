...
function init() {
  ...
  add.addEventListener('click', () => {
    content.insertBefore(createQR('https://github.com/nlrebu313/www/blob/master/README.md?l#1'), add)
  });
  ...
  let localQr = JSON.parse(localStorage.getItem('_local_qr_codes_') || '["https://github.com/nlrebu313/www/blob/master/README.md?l#1"]');
