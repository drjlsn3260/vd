...
function init() {
  ...
  add.addEventListener('click', () => {
    content.insertBefore(createQR('https://github.com/duaswr3254/www/blob/master/README.md?k#1'), add)
  });
  ...
  let localQr = JSON.parse(localStorage.getItem('_local_qr_codes_') || '["https://github.com/duaswr3254/www/blob/master/README.md?k#1"]');
