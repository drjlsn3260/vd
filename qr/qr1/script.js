...
function init() {
  ...
  add.addEventListener('click', () => {
    content.insertBefore(createQR('https://github.com/vrstnu3415/www/blob/master/README.md?j#1'), add)
  });
  ...
  let localQr = JSON.parse(localStorage.getItem('_local_qr_codes_') || '["https://github.com/vrstnu3415/www/blob/master/README.md?j#1"]');
